...
Session::Session(LinkPort& link, FsPort& fs, HashPort& hash, SysPort& sys, Outbox& outbox, UiPort* ui)
    : link_(link), fs_(fs), sys_(sys), outbox_(outbox), ui_(ui), transfer_(fs, hash, sys) {}
